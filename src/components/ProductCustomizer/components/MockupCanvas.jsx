...
export default function MockupCanvas({ mockupImg, color, logo, scale, draggableRef, fileInputRef, onRemoveLogo }) {
  return (
    <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center select-none bg-white/50 rounded-2xl border border-gray-100/50 my-auto p-6">
